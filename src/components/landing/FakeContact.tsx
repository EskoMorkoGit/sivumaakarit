            ...
            <div className="container mx-auto px-4 max-w-xl relative p-8">
                ...
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-stone-200">
                    <form className="space-y-6">
                        <div>
                            <label className="block text-sm font-medium text-stone-700 mb-1">Nimi</label>
                            <input 
                                type="text" 
                                readOnly
                        ...
                        <div>
                            <label className="block text-sm font-medium text-stone-700 mb-1">Sähköposti</label>
                            <input 
                                type="email" 
                                readOnly
                                onFocus={handleInteraction}
                        ...
                        <div>
                            <label className="block text-sm font-medium text-stone-700 mb-1">Mökin sijainti & tarve</label>
                            <textarea 
                                rows={3} 
                                readOnly
                                onFocus={handleInteraction}
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-4">
                            <button 
                                type="button"
                                onClick={handleInteraction}
                                className="flex-1 bg-stone-200 text-stone-500 font-bold py-3 px-6 rounded-lg uppercase tracking-wide cursor-not-allowed hover:bg-stone-300 transition-colors"
                            >
                                Lähetä viesti
                            </button>
                            <a 
