...
export function FAQ() {
    ...
    const faqs = [
        ...
        },
        {
            ...
            q: "Miksi maksaisin 990 € verkkosivuista, kun niitä saa halvalla muualtakin?",
            a: "Useimmat halvat ratkaisut tarjoavat vain ”digitaalisen tontin”, mutta me toimitamme valmiin myyntikoneen. 990 € investointi sisältää Tehorunko-nettisivu-standardin mukaisen toteutuksen, joka on optimoitu tuomaan uusia asiakkaita heti ensimmäisestä päivästä alkaen. Koska suuri osa asiakkaista tekee valintansa yrityksen nettisivujen perusteella, sivu maksaa itsensä takaisin jo muutamalla uudella keikalla. Esimerkiksi perinteinen kattoremontti saattaa maksaa 8000 € – meiltä saat työkalun, joka maksaa itsensä takaisin viikoissa ja palvelee vuosia. * Lähde: TrekkSoft Travel Trend Report 2019."
        },
        {
            q: "Mitä 50 € kuukausittainen ylläpito oikeasti sisältää?",
            a: "Ylläpito ei ole vain säilytystä, vaan vakuutus sivusi suorituskyvylle ja mielenrauhallesi. Sinä keskityt täysillä omaan työhösi – me hoidamme teknisen tekemisen. Se sisältää verkkotunnuksen, SSL-suojauksen, jatkuvan teknisen valvonnan, pienet kuukausittaiset päivitykset sekä AIO-päivitykset."
        },
        {
            q: "Mikä on tämä 100/100-takuu ja miksi se on tärkeä?",
            a: "Se on meidän lupauksemme laadusta. Ajamme jokaiselle sivulle Googlen virallisen Lighthouse-testin, jossa vaadimme täydet 100 pistettä SEO:ssa, esteettömyydessä ja parhaissa käytännöissä. Tehokkuuden osalta tavoitteemme on vähintään 90 pistettä (tukevasti vihreällä), mikä on valovuosia edellä tavallisia nettisivuja. Tämä takaa, että Google ja tekoäly suosittelevat juuri sinun yritystäsi."
        },
        {
            q: "Miten toimitus voi olla vain 7 päivää?",
            a: "Me teemme työt puolestasi, jotta sinun ei tarvitse tuhlata aikaasi projektiin. Emme aloita nollasta, vaan käytämme huippuunsa testattua pohjaa ja hyödynnämme tekoälyä sisällön- ja koodintuotannon optimoinnissa. Kun annat meille perustiedot myymästäsi palvelusta, me jalostamme siitä iskevän myyntipuheen ja istutamme sen valmiiseen runkoon. Sinun tehtäväksesi jää vain nauttia valmiista, liidejä tuovasta lopputuloksesta."
        },
        {
            q: "Voinko todella saada sivut ilmaiseksi pilottiasiakkaana?",
            a: "Kyllä. Etsimme juuri nyt muutamaa referenssiä, joille tarjoamme 990 euron arvoisen toteutuksen 0 eurolla. Ainoa ehtosi on sitoutua 50 euron kuukausittaiseen ylläpitoon, jotta voimme taata sivun laadun jatkossakin, sekä antaa rehellisen palautteen yhteistyöstä."
        }
    ];
                ...
                <div className="space-y-4">
                    {faqs.map((faq, index) => (
                        ...
                        >
                            ...
                            >
                                <span className={`${inter.className} text-lg font-bold text-slate-800`}>{faq.question || (faq as any).q}</span>
                            ...
                            >
                                <div className="px-6 pb-6 pt-0">
                                    <p className={`${inter.className} text-stone-600 leading-relaxed font-light`}>
